...
const YOUTUBE_VIDEO_ID = "pIPOCauIHKw";
const OFFICIAL_DOWNLOAD_URL = "https://ascension.gg/en/download";
const OFFICIAL_NEWS_URL = "https://ascension.gg/en/news/conquest-of-azeroth";
      ...
      <section className="text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <Button asChild size="lg">
            <Link href={OFFICIAL_DOWNLOAD_URL}>{home.hero.primaryCta}<ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
                      ...
                      {mod.highlights.map((h, i) => {
                        ...
                        return (
                          <div key={i} className={`rounded-xl border p-4 ${tierColor}`}>
                            <span className={`text-sm font-bold ${tierText}`}>{home.explore.tierLabel.replace("{tier}", h.label)}</span>
